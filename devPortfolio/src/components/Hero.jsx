  ...
  return (
    <div className='
      ...
      <div className='
        ...
        <h2 className='font-pacifico text-4xl text-white text-center
          md:text-left md:text-5xl
          lg:text-7xl'>
        ...
        <p className='font-poppins font-light text-sm text-white text-center
                      lg:text-left'>
        ...
        <a 
          ...
          <button className={`bg-[#7477FF] hover:bg-[#6a6cff] text-white font-bold py-2 px-4 rounded items-center`}>
