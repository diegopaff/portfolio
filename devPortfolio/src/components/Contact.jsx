        ...
        <form ref={form} className="w-full max-w-lg px-3 gap-1" onSubmit={handleSubmit(sendEmail)}>
            <div className="flex flex-wrap -mx-3 mb-1">
                <div className="w-full md:w-full px-3 mb-1 md:mb-0">
                    <label className="block  tracking-wide text-black dark:text-white text-base font-semibold mb-2" htmlFor="nombre">
                        Nombre
                    </label>
                    <input  
            ...
            <div className="flex flex-wrap -mx-3 mb-1">
                <div className="w-full px-3">
                    <label className="block tracking-wide text-black dark:text-white text-base font-semibold mb-2" htmlFor="email">
                        E-mail
                    </label>
                    <input  
            ...
            <div className="flex flex-wrap -mx-3 mb-1">
                <div className="w-full px-3">
                    <label className="block tracking-wide text-black dark:text-white text-base font-semibold mb-2" htmlFor="message">
                        Mensaje
                    </label>
                    <textarea 
